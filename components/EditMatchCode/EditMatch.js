...
import {View, Text, Button, TouchableOpacity, StyleSheet, Image, Modal, FlatList, TextInput} from 'react-native';
import database from '@react-native-firebase/database';
import Loader from '../Screens/Loader';

export default function EditMatch({navigation, route}) {
