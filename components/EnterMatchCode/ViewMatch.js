...
export default function ViewMatch({navigation, route}) {
  ...
  if (matchFinished) {
    return (
      <View
        ...
        />
        <Text style={styles.successTextStyle}>{winningStatement}</Text>
        <TouchableOpacity
  ...
  return (
    <View style={{flex: 1, padding: 10, backgroundColor: '#1e1e1e'}}>
      <View style={{flex: 1.5, padding: 10}}>
        ...
        <Text style={{...styles.headingText, fontSize: 15}}> (Group Match)</Text>
        }
        {propsData?.matchType==="Semi" && 
        <Text style={{...styles.headingText, fontSize: 15}}> (Semi Final)</Text>
        }
        {propsData?.matchType==="Final" && 
        <Text style={{...styles.headingText, fontSize: 15}}> (Final)</Text>
        }
        </>
        }
        </Text>
      </View>
      <View style={{...styles.heading, backgroundColor: 'yellow', borderColor: 'yellow'}}>
          <Text style={{...styles.headingText, color: '#ca3232'}}>Match Code: {matchCode}</Text>
        </View>
      </>
